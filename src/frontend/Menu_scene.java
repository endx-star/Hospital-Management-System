...
public class Menu_scene {
    ...
    public Scene main() throws SQLException, ClassNotFoundException {
        ...
        vBox_left.setId("rotter");
        // scene.getStylesheets().add(Login.class.getResourse(""));
//////////set Accelerator for this scene
    ...
    public void btnStyle(Button btn, String code) {
        if (code.equals("@hover")) {
            ...
            // btn.setId("root");
            btn.getStylesheets().add("Style_package/tableStyle.css");/// external style sheet
    ...
    private Pane menu_provider() {
        ...
        btnBilling.setId("root");///for css

////////////////InPatients's button/////////////
        btn_in_patient = new Button(" PATIENT ");
        ...
        btn_in_patient.setOnAction(e -> {
                ...
                try {
                    boolean flag = Login_controller.isAdmin(userName, "Administrator");
                    if (!flag) {
                        AlertBox.selectionChecker("No permission to access this file!", "Acces controll");
                        return;
                    }
...
//////////Staff information///////////////
        ...
        btnDoctor.setId("root");

//////////Pathology///////

        btnPathology = new Button("PATHOLOGY");
        btnPathology.setStyle("background-image: url(lab.jpeg);");
        ...
        btnPathology.setId("root");

        btnPathology.setOnAction(e ->{
        try {
            boolean flag = Login_controller.isAdmin(userName, "Administrator");
            if (!flag) {
                AlertBox.selectionChecker("No permission to access this file!", "Acces controll");
        ...
        ///////////menu container////////////////////////
        logout().setAlignment(Pos.BOTTOM_RIGHT);
        logout().setId("root");///////
       ...
       /* Image img=new Image("Doctor.PNG");
        ...
        vBox_menu.getChildren().addAll(btn_in_patient, btnDoctor, btnBilling, btnPathology, logout());
    ...
    private MenuBar menu_bar() throws SQLException, ClassNotFoundException {
        ...
        modify.setOnAction(e -> {
            account_form("Change Password", 0);
        });
        MenuItem changAccount = new MenuItem("_Change the account name");
        changAccount.setOnAction(e -> {
            account_form("Rename Account", 1);
        });
        ...
        else System.out.println("statndard");
        System.out.println(flag);
        createAccount.setDisable(flag);
        createAccount.setOnAction(e -> {
            account_form("Add New User", 2);
        });

        MenuItem privacy = new MenuItem("_Privacy");
        privacy.setDisable(true);
        MenuItem userAccounts = new MenuItem("_User Accounts");
        userAccounts.setOnAction(e -> {
            account_form("Manage Accounts", 3);
        });
