...
public class InputValidator {
    ...
    public static boolean validateDouble(String number) {
        ...
        return matcher.find() || number.isEmpty();
    }
    ...
    public static void keyTypedNumberHandler(Tooltip lbl, TextField letter, String type) {//(tooltip1, testId, "process");
    ...
    public static void doubleFormatValidator(Tooltip lbl, TextField letter, String type) {
        if (!validateDouble(letter.getText().trim())) {
            if (!lbl.isShowing()) {
